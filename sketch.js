...
function getFigurePath() {
  return 'images/' + $('input[name="options"]:checked').parent().text().trim() + '.jpg';
}
...
function setup() {
  ...
  let choice = $('input[name="options"]:checked').parent().text().trim();
  style = ml5.styleTransfer('models/' + choice, video, modelLoaded);
}
